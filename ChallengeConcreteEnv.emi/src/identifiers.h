...
#define STATE_CommunicationPlayer_Connection			1
#define STATE_CommunicationPlayer_CheckStatus			2
#define STATE_CommunicationPlayer_Idle			3
#define STATE_CommunicationPlayer_Connected			4
#define STATE_CommunicationPlayer_ReadSuction			5
...
#define STATE_CommunicationReferee_CheckStatus			2
#define STATE_CommunicationReferee_Idle			3
#define STATE_CommunicationReferee_Connected			4
#define STATE_CommunicationReferee_Error			5
